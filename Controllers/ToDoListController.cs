...
namespace MvcToDoList.Controllers
{
    public class ToDoListController : Controller
    {
        ...
        public async Task<IActionResult> Index(string toDoListPriority ,string toDoListStatus, string searchString)
        {
            ...
            {
                toDoList = toDoList.Where(s => s.TaskName!.Contains(searchString));
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,TaskName,Description,Status,Priority,Created,Deadline")] ToDoList toDoList)
        {
            if(toDoList.TaskName == toDoList.Description)
            {
                ModelState.AddModelError("TaskName", "The Task name cannot exactly match the Description.");
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TaskName,Description,Status,Priority,Created,Deadline")] ToDoList toDoList)
        {
            if (id != toDoList.Id)
            {
                return NotFound();
